...
- Gitlab 地址：[https://gitlab.caetar.net/ihospital/knt-platform/knt-platform-admin](https://gitlab.caetar.net/ihospital/knt-platform/knt-platform-admin)
- 测试环境地址：[https://test-platform.knt.net/](https://test-platform.knt.net/)
- 生产环境地址：[https://console-v2.caetar.com/](https://console-v2.caetar.com/)

## 多租户商城协作方管理平台（运营端、供应商端、医院端）（后管）

- Gitlab 地址：[https://gitlab.caetar.net/ihospital/knt-platform/knt-business-platform-fe](https://gitlab.caetar.net/ihospital/knt-platform/knt-business-platform-fe)
- 测试环境地址：[https://test-tenant.knt.net/](https://test-tenant.knt.net/)
- 生产环境地址：[https://partner.caetar.com/](https://partner.caetar.com/)

## 多租户商城平台端掌上工作平台（入口钉钉）

- Gitlab 地址：[https://gitlab.caetar.net/ihospital/knt-platform/knt-mplatform-fe](https://gitlab.caetar.net/ihospital/knt-platform/knt-mplatform-fe)
- 测试环境地址：[https://test-health.caetar.com/mplatform](https://test-health.caetar.com/mplatform)
- 生产环境地址：[https://mobile.caetar.com/](https://mobile.caetar.com/)

## 多租户商城C端（商城）

- Gitlab 地址：[https://gitlab.caetar.net/ihospital/knt-platform/knt-platform-fe](https://gitlab.caetar.net/ihospital/knt-platform/knt-platform-fe)
- 测试环境地址：[https://test-health.caetar.com/channel/home?channelId=](https://test-health.caetar.com/channel/home?channelId=822031807215813)
- 生产环境地址：[https://health.caetar.com/channel/home?channelId=](https://health.caetar.com/channel/home?channelId=821999634327749)
...
- Gitlab 地址：[https://gitlab.caetar.net/ihospital/knt-fe/knt-external-admin-fe](https://gitlab.caetar.net/ihospital/knt-fe/knt-external-admin-fe)
- 测试环境地址：[https://test-work.knt.net/](https://test-work.knt.net/)
- 生产环境地址：[https://work.caetar.com/](https://work.caetar.com/)
...
- Gitlab 地址：[https://gitlab.caetar.net/ihospital/knt-fe/hospital-medical-fe](https://gitlab.caetar.net/ihospital/knt-fe/hospital-medical-fe)
